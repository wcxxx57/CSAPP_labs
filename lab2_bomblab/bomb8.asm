...
bomb8:     file format elf64-x86-64
...
000000000000160b <phase_2>:
    ...
    160f:	55                   	push   %rbp
    1610:	53                   	push   %rbx  # 被调用者寄存器
    1611:	48 83 ec 28          	sub    $0x28,%rsp    # stack区延伸
    1615:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    161c:	00 00 
    161e:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    1623:	31 c0                	xor    %eax,%eax       # %eax清零 初始化寄存器
    1625:	48 89 e6             	mov    %rsp,%rsi      # 将rsp加载到rsi 为函数调用做准备
    1628:	e8 06 06 00 00       	call   1c33 <read_six_numbers>
    162d:	83 3c 24 00          	cmpl   $0x0,(%rsp)    # rsp此时装第一个数
    1631:	78 0a                	js     163d <phase_2+0x32> # 如果第一个数小于0会爆炸
    1633:	48 89 e5             	mov    %rsp,%rbp      # rbp=rsp=第一个数的地址
    1636:	bb 01 00 00 00       	mov   从 $0x1,%ebx    # rbx置1（初始化）
    ...
    # ebx再加一=2 ebx是计数器
    1647:	48 83 c5 04          	add    $0x4,%rbp # rbp变为第二个数索引
    164b:	83 fb 06             	cmp    $0x6,%ebx #  若是ebx=6 就结束（6个数）
    164e:	74 11                	je     1661 <phase_2+0x56>
    1650:	89 d8                	mov    %ebx,%eax  # eax=ebx=序号
    1652:	03 45 00             	add    0x0(%rbp),%eax # 运行完这行后eax=序号+rbp索引的数（序号索引的数）
    1655:	39 45 04             	cmp    %eax,0x4(%rbp) # 0x4(%rbp)为第二个数 下一个数应=前一个数+序号
    1658:	74 ea                	je     1644 <phase_2+0x39>
    165a:	e8 a8 05 00 00       	call   1c07 <explode_bomb> # 循环
...
000000000000167d <phase_3>:
    ...
    1695:	48 8d 4c 24 04       	lea    0x4(%rsp),%rcx  # 执行后rcx为-1
    169a:	48 89 e2             	mov    %rsp,%rdx  # rdx=rsp=56
    169d:	48 8d 35 8b 1c 00 00 	lea    0x1c8b(%rip),%rsi        # 332f <array.0+0x14f> 
    16a4:	e8 57 fc ff ff       	call   1300 <__isoc99_sscanf@plt>
    16a9:	83 f8 01             	cmp    $0x1,%eax   # eax是返回值 scanf返回值--检测输入个数 要有2个
    16ac:	7e 1a                	jle    16c8 <phase_3+0x4b> # eax小于等于1会炸 
    16ae:	83 3c 24 07          	cmpl   $0x7,(%rsp) # rsp装的是第一个值 要小于等于7 （rsi装第二个值）
    16b2:	77 65                	ja     1719 <phase_3+0x9c>
    16b4:	8b 04 24             	mov    (%rsp),%eax # eax装第一个值
    16b7:	48 8d 15 02 1b 00 00 	lea    0x1b02(%rip),%rdx   # rdx=101？     # 31c0 <_IO_stdin_used+0x1c0>
    16be:	48 63 04 82          	movslq (%rdx,%rax,4),%rax  # movslq将有符号数从32位拓展为64位
    16c2:	48 01 d0             	add    %rdx,%rax
    16c5:	3e ff e0             	notrack jmp *%rax  # 条件跳转
    16c8:	e8 3a 05 00 00       	call   1c07 <explode_bomb>
    16cd:	eb df                	jmp    16ae <phase_3+0x31>
    16cf:	b8 de 00 00 00       	mov    $0xde,%eax
    16d4:	39 44 24 04          	cmp    %eax,0x4(%rsp) # 第二个数和eax比大小 不相等就会爆炸
    ...
    16ee:	c3                   	ret    
    16ef:	b8 5c 02 00 00       	mov    $0x25c,%eax
    16f4:	eb de                	jmp    16d4 <phase_3+0x57>
    16f6:	b8 95 03 00 00       	mov    $0x395,%eax
    16fb:	eb d7                	jmp    16d4 <phase_3+0x57>
    16fd:	b8 94 01 00 00       	mov    $0x194,%eax
    1702:	eb d0                	jmp    16d4 <phase_3+0x57>
    1704:	b8 bf 02 00 00       	mov    $0x2bf,%eax
    1709:	eb c9                	jmp    16d4 <phase_3+0x57>
    170b:	b8 1a 01 00 00       	mov    $0x11a,%eax       # 这是第六个
    1710:	eb c2                	jmp    16d4 <phase_3+0x57>
    1712:	b8 a3 01 00 00       	mov    $0x1a3,%eax
    ...
    1725:	b8 ca 01 00 00       	mov    $0x1ca,%eax
...
0000000000001738 <func4>:   # 递归二分查找
    1738:	f3 0f 1e fa          	endbr64 
    173c:	53                   	push   %rbx       # 初始r=edx=e,l=esi=0
    173d:	89 d0                	mov    %edx,%eax     # eax = edx
    173f:	29 f0                	sub    %esi,%eax     # eax-=esi
    1741:	89 c3                	mov    %eax,%ebx     # ebx = eax
    1743:	c1 eb 1f             	shr    $0x1f,%ebx # 逻辑右移31位  # 取ebx(eax)的符号位 （为了使l-r为负时除2也能下取整）
    1746:	01 c3                	add    %eax,%ebx    # t=r-l 若x>=y:+0;否则+1
    1748:	d1 fb                	sar    %ebx # 算术右移 # t//2
    174a:	01 f3                	add    %esi,%ebx # y+t//2 ===mid
    174c:	39 fb                	cmp    %edi,%ebx # mid和第一个参数(w)比较
    174e:	7f 06                	jg     1756 <func4+0x1e> # mid>w
    1750:	7c 10                	jl     1762 <func4+0x2a> # mid<w
    1752:	89 d8                	mov    %ebx,%eax  # return mid 
    1754:	5b                   	pop    %rbx
    1755:	c3                   	ret    
    1756:	8d 53 ff             	lea    -0x1(%rbx),%edx  # r=mid-1
    1759:	e8 da ff ff ff       	call   1738 <func4> 
    175e:	01 c3                	add    %eax,%ebx # 注意这里有个累加！！ mid += eax（返回值）！！！ 
...
000000000000176e <phase_4>:
    ...
    178e:	48 8d 35 9a 1b 00 00 	lea    0x1b9a(%rip),%rsi  # 要输入两个十进制数      # 332f <array.0+0x14f>
    1795:	e8 66 fb ff ff       	call   1300 <__isoc99_sscanf@plt>
    179a:	83 f8 02             	cmp    $0x2,%eax
    179d:	75 06                	jne    17a5 <phase_4+0x37>
    179f:	83 3c 24 0e          	cmpl   $0xe,(%rsp) # rsp是第一个参数 应小于等于0xe
    17a3:	76 05                	jbe    17aa <phase_4+0x3c> # jbe无符号数小于等于
    17a5:	e8 5d 04 00 00       	call   1c07 <explode_bomb>
    17aa:	ba 0e 00 00 00       	mov    $0xe,%edx # edx = e
    17af:	be 00 00 00 00       	mov    $0x0,%esi # esi = 0
    17b4:	8b 3c 24             	mov    (%rsp),%edi # edi = nums[0]
    17b7:	e8 7c ff ff ff       	call   1738 <func4>
    17bc:	83 f8 1f             	cmp    $0x1f,%eax   # func4返回值要等于31
    17bf:	75 07                	jne    17c8 <phase_4+0x5a>
    17c1:	83 7c 24 04 1f       	cmpl   $0x1f,0x4(%rsp)  # 第二个数要等于31
...
00000000000017e7 <phase_5>:
    ...
    1807:	48 8d 35 21 1b 00 00 	lea    0x1b21(%rip),%rsi  # 两个整数x,y     # 332f <array.0+0x14f>
    180e:	e8 ed fa ff ff       	call   1300 <__isoc99_sscanf@plt>
    1813:	83 f8 01             	cmp    $0x1,%eax
    1816:	7e 5a                	jle    1872 <phase_5+0x8b>
    1818:	8b 04 24             	mov    (%rsp),%eax  # eax=(rsp)=x
    181b:	83 e0 0f             	and    $0xf,%eax # 提取x后四位 %16
    181e:	89 04 24             	mov    %eax,(%rsp)
    1821:	83 f8 0f             	cmp    $0xf,%eax  
    1824:	74 32                	je     1858 <phase_5+0x71> # 后四位不能都是1(x不能是16的倍数)
    1826:	b9 00 00 00 00       	mov    $0x0,%ecx  # 累加器
    182b:	ba 00 00 00 00       	mov    $0x0,%edx  # 计数器
    1830:	48 8d 35 a9 19 00 00 	lea    0x19a9(%rip),%rsi  # 基地址  # 31e0 <array.0>
    1837:	83 c2 01             	add    $0x1,%edx
    183a:	48 98                	cltq    # 有符号拓展为64位
    183c:	8b 04 86             	mov    (%rsi,%rax,4),%eax
    183f:	01 c1                	add    %eax,%ecx  # 将索引加上去
    1841:	83 f8 0f             	cmp    $0xf,%eax  # 遇到15停止
    1844:	75 f1                	jne    1837 <phase_5+0x50> # 循环
    1846:	c7 04 24 0f 00 00 00 	movl   $0xf,(%rsp)
    184d:	83 fa 0f             	cmp    $0xf,%edx
    1850:	75 06                	jne    1858 <phase_5+0x71>  # 一定要循环15次
    1852:	39 4c 24 04          	cmp    %ecx,0x4(%rsp)       # 这边也一定要相等
...
000000000000187e <phase_6>:
    ...
    18df:	41 8b 45 00          	mov    0x0(%r13),%eax # 此时eax是第一个数
    ...
    18f6:	be 00 00 00 00       	mov    $0x0,%esi         # r14大于5来这
    18fb:	8b 0c b4             	mov    (%rsp,%rsi,4),%ecx  # ecx = 第一个数
    18fe:	b8 01 00 00 00       	mov    $0x1,%eax     # eax=0
...
0000000000001af3 <strings_not_equal>:
    ...
    1b24:	b8 00 00 00 00       	mov    $0x0,%eax  # rax又用作计数器
    1b29:	38 54 05 00          	cmp    %dl,0x0(%rbp,%rax,1) # 与目标字符串的下一个字符比较
    1b2d:	75 1a                	jne    1b49 <strings_not_equal+0x56>
    1b2f:	48 83 c0 01          	add    $0x1,%rax # 计数器++
    1b33:	0f b6 14 03          	movzbl (%rbx,%rax,1),%edx # 提取输入字符串的下一个字符
    1b37:	84 d2                	test   %dl,%dl
    1b39:	75 ee                	jne    1b29 <strings_not_equal+0x36> # 如果没有结束 继续循环
    1b3b:	b8 00 00 00 00       	mov    $0x0,%eax # 成功到达结尾 相等 返回0
    1b40:	eb 0c                	jmp    1b4e <strings_not_equal+0x5b>
    1b42:	b8 00 00 00 00       	mov    $0x0,%eax
    1b47:	eb 05                	jmp    1b4e <strings_not_equal+0x5b>
    1b49:	b8 01 00 00 00       	mov    $0x1,%eax # 有字符不相等跳到这里 返回1
    1b4e:	5b                   	pop    %rbx
    1b4f:	5d                   	pop    %rbp
    1b50:	41 5c                	pop    %r12
    1b52:	c3                   	ret    
...
0000000000001c33 <read_six_numbers>:
    ...
    1c3b:	48 89 f2             	mov    %rsi,%rdx   # rsi为数组起点 rdx变为输入字符串的地址
    1c3e:	48 8d 4e 04          	lea    0x4(%rsi),%rcx #2
    1c42:	48 8d 46 14          	lea    0x14(%rsi),%rax  #6
    1c46:	50                   	push   %rax # 给scanf传递参数（地址） 寄存器不够 通过栈传递
    1c47:	48 8d 46 10          	lea    0x10(%rsi),%rax  
    1c4b:	50                   	push   %rax
    1c4c:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9  #4
    1c50:	4c 8d 46 08          	lea    0x8(%rsi),%r8  #5
    1c54:	48 8d 35 c8 16 00 00 	lea    0x16c8(%rip),%rsi  # 加载格式字符串"%d %d %d %d %d %d"      # 3323 <array.0+0x143>
    1c5b:	b8 00 00 00 00       	mov    $0x0,%eax # eax清零
    1c60:	e8 9b f6 ff ff       	call   1300 <__isoc99_sscanf@plt> # 调用scanf
    1c65:	48 83 c4 10          	add    $0x10,%rsp # 恢复16字节栈空间
    1c69:	83 f8 05             	cmp    $0x5,%eax # scanf返回值是否大于5（是否成功读取至少6个数）
    1c6c:	7e 05                	jle    1c73 <read_six_numbers+0x40> # 如果小于等于5 爆炸
